define("pp_viz_ext_waterfallchartv3-src/js/propertyeditor/spec", ["pp_viz_ext_waterfallchartv3-src/js/propertyeditor/renderers/checkbox"],
	...
	var spec = {
		...
		"dependencies": [],
		"components": [{
			"id": "sample.openpe.waterfallchartv3.extension",
			"provide": "sap.viz.controls.propertyeditor.view",
			"instance": {
				'charts': ['pp.viz.ext.waterfallchartv3'],
				'view': {
					'sections': [{
